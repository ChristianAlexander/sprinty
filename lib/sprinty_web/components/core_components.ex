defmodule SprintyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SprintyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SprintyWeb.Gettext, "errors", msg, opts)
    end
  end
